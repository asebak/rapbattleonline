...
namespace RapBattleAudio.classes
{
    ...
    public class WaveMediaStreamSource : MediaStreamSource, IDisposable
    {
        ...
        protected override void SeekAsync(long seekToTime)
        {
            ...
            this.currentPosition = this.wavParser.WaveFormatEx.BufferSizeFromAudioDuration(seekToTime) +
                                   this.startPosition;
            this.wavParser.MoveToChunkOffset((uint) this.wavParser.WaveFormatEx.BufferSizeFromAudioDuration(seekToTime));
            //correction posted by original author at http://blogs.msdn.com/b/gillesk/archive/2009/03/23/playing-back-wave-files-in-silverlight.aspx#10388916
