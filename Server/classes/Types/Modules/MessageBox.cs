...
namespace FreestyleOnline.classes.Types.Modules
{
    public class MessageBox : BaseControl
    {
        ...
        {
            get { return this.buttons ?? (this.buttons = new List<HyperLink>()); }
        }
        ...
        public string MessageText
        {
            ...
            set { this.ViewState["MessageText"] = value; }
        }
        ...
        public string Title
        {
            get { return this.ViewState["Title"] != null ? this.ViewState["Title"].ToString() : "Info"; }
