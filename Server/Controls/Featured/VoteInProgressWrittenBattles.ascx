<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VoteInProgressWrittenBattles.ascx.cs" Inherits="FreestyleOnline.Controls.Featured.VoteInProgressWrittenBattles" %>
...
<div id="voteprogressWrittenBattles" class="jcarousel-skin-tango">
    <ul>
        <asp:Repeater ID="VotingProgressWrittenBattlesRepeater" runat="server">
            <ItemTemplate>
