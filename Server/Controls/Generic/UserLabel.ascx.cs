...
{
    public partial class UserLabel : BaseUserControl
    {
        #region Properties
        ...
        {
            get { return this.ViewState["CssClass"] != null ? this.ViewState["CssClass"].ToString() : string.Empty; }
        ...
        {
            get { return this.ViewState["OnClick"] != null ? this.ViewState["OnClick"].ToString() : string.Empty; }
        ...
        public string Style
        {
            get { return this.ViewState["Style"] != null ? this.ViewState["Style"].ToString() : string.Empty; }
